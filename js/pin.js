...
(function () {
  ...
  var renderPin = function (object) {
    ...
    pinElement.style =
      'left: ' + (object.location.x - window.data.PIN_WIDTH / 2) + 'px;' +
      ' top: ' + (object.location.y - window.data.PIN_HEIGHT) + 'px;';
    pinElement.querySelector('img').src = object.author.avatar;
    pinElement.querySelector('img').alt = object.offer.title;

    var onClickOpenPopup = function () {
    ...
    pinElement.addEventListener('click', onClickOpenPopup);
    return pinElement;
  };
